...
//******************* debut : champ ********************
    ...
    $(".buttonPrevious").click(function()
        {
            ...
            window.location.href = "/champ/previous/" + champId;
        }
    );
    ...
    $(".buttonNext").click(function()
        {
            var champId = $(this).data('champ')
            window.location.href = "/champ/next/" + champId;
        }
    );
            ...
            $.confirm({
                ...
                buttons: {
                    Confirmer: function ()
                    {
                        ...
                        //appel controller
                        window.location.href = "/ressource/updateRangeMax/" + id + "/" + newRangeMax + "/" + page
                    },
                    Annuler: function ()
                    {
    ...
    $(".cliquableRessource").click(function()
        {
            ...
            $.confirm({
                ...
                buttons: {
                    Confirmer: function () {
                        window.location.href = "/ressource/delete/" + id;
                    },
                    Annuler: function () {
                        console.log('annuler');
                    },
...
//**************** debut : fichePerso ************
    ...
    $("#btnDeleteFiche").click(function ()
    {
        ...
        $.confirm({
            ...
            buttons: {
                Confirmer: function () {
                    window.location.href = "/fiche/" + id + "/delete" ;
                },
                Annuler: function () {
                    console.log('annuler');
                },
