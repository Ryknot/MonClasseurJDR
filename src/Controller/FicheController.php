...
class FicheController extends AbstractController
{
     ...
     */
    public function ficheDetail(int $id, FichePersoRepository $fichePersoRepository, TypeInfoRepository $infoRepository, ChampsRepository $champRepository, RessourceRepository $ressourceRepository, Request $request): Response
    {
